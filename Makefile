...
delete-shipping:
	...
	-f ./shipping/tasks/taskdeployrun.yaml -f ./shipping/tasks/pipeline.yaml -f ./shipping/tasks/pipelinerun.yaml -n test
ins-catlog:
		kubectl create -f ./catalogue/serviceAccount.yaml -f./catalogue/role-bind.yaml -f ./catalogue/tasks/piperes.yaml -f ./catalogue/tasks/taskbuildandpush.yaml -f ./catalogue/tasks/taskbuildandpushrun.yaml \
