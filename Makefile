...
ins-user:
	...
	-f ./user/tasks/taskrun.yaml -f ./user/tasks/taskdb.yaml -f ./user/tasks/taskdbrun.yaml  -f ./user/tasks/taskdeploy.yaml 	-f ./user/tasks/taskrun.yaml -f ./user/tasks/taskdeploy.yaml -f ./user/tasks/taskdeployrun.yaml -f  ./user/tasks/taskdbdeploy.yaml -f   ./user/tasks/taskdbdeployrun.yaml -f ./user/tasks/pipeline.yaml \
